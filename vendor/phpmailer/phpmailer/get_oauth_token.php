...
/**
 * Get an OAuth1 token from an OAuth1 provider.
 ...
 * @see https://oauth1-client.thephpleague.com/providers/thirdparty/
 */
//@see https://github.com/thephpleague/oauth1-google
use League\OAuth1\Client\Provider\Google;
//@see https://packagist.org/packages/hayageek/oauth1-yahoo
use Hayageek\OAuth1\Client\Provider\Yahoo;
//@see https://github.com/stevenmaguire/oauth1-microsoft
use Stevenmaguire\OAuth1\Client\Provider\Microsoft;
//@see https://github.com/greew/oauth1-azure-provider
use Greew\OAuth1\Client\Provider\Azure;
...
if (!isset($_GET['code'])) {
    ...
    $_SESSION['oauth1state'] = $provider->getState();
    header('Location: ' . $authUrl);
    exit;
    //Check given state against previously stored one to mitigate CSRF attack
} elseif (empty($_GET['state']) || ($_GET['state'] !== $_SESSION['oauth1state'])) {
    unset($_SESSION['oauth1state']);
