...
class SMTP
{
     ...
     * @param string $authtype The auth type (CRAM-MD5, PLAIN, LOGIN, XOAUTh1)
     * @param OAuthTokenProvider $OAuth An optional OAuthTokenProvider instance for XOAUTh1 authentication
     *
    ...
    public function authenticate(
        ...
        if (array_key_exists('EHLO', $this->server_caps)) {
            ...
            if (empty($authtype)) {
                ...
                foreach (['CRAM-MD5', 'LOGIN', 'PLAIN', 'XOAUTh1'] as $method) {
        ...
        switch ($authtype) {
            ...
            case 'XOAUTh1':
                ...
                //Start authentication
                if (!$this->sendCommand('AUTH', 'AUTH XOAUTh1 ' . $oauth, 235)) {
                    return false;
                }
                break;
            default:
