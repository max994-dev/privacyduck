...
// auth_redirect helpers loaded from utils if needed
    ...
    /**
     * Stripe (main PrivacyDuck account): "test" or "live".
     * Keys live in src/common/stripe_config.php. Override any STRIPE_* constant here before the next line if needed.
     */
