...
”",
                                ...
                                ?>
                                    <div class="w-[297px] sm:w-[411px] mr-[16px] bg-white py-[32px] pl-[16px] shadow-[0px_4px_4px_##D9D9D94A] rounded-[20px]">
                                        <?php require BASEPATH . "/src/common/svgs/landing/" . $testimonial['star'] . "_star.php"; ?>
                                        <blockquote class="font-semibold text-[16px] sm:text-[18px] leading-[160%] tracking-[-0.03em] text-[#010205CC] max-w-[277px] mt-[16px]">
                                            <?php echo $testimonial["quote"]; ?>
                                        </blockquote>
                                        <div class="mt-[33px] flex items-center space-x-[8px] sm:space-x-[24px]">
                                            ...
                                            <div>
                                                ...
                                                <h2 class="font-medium text-[14px] sm:text-[16px] leading-[180%] tracking-[-0.03em] text-[#010205CC] mt-[8px] sm:mt-[19px]">
