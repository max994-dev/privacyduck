...
<div class="relative overflow-hidden rounded-br-[32px] rounded-bl-[32px] bg-[#FAFAFA] lg:h-screen bg-cover bg-center bg-no-repeat">
        ...
        <div class="flex flex-col">
            <div class="flex items-center space-x-[6px] text-center sm:text-left">
                <a href="/" class="flex items-center space-x-[6px]">
                    <h2 class="text-[#515665] text-[14px] sm:text-[16px] font-medium leading-[180%]">Home</h2>
                </a>
                <a href="" class="flex items-center space-x-[6px]">
                    <?php require(BASEPATH . "/src/common/svgs/sitecover/small_sign.php"); ?>
                    <h2 class="text-[#515665] text-[14px] sm:text-[16px] font-medium leading-[180%]">Restoration</h2>
                </a>
            </div>
            <div class="mt-[40px] sm:mt-[60px] md:mt-[90px] flex flex-col gap-[24px] sm:gap-[32px] md:gap-[48px] max-w-[576px]">
                <div>
                    <div class="flex flex-col sm:flex-row gap-[8px] sm:gap-[16px] text-center sm:text-left">
                        ...
                        <h2 class="font-semibold text-[#9B9B9C] text-[14px] sm:text-[16px] leading-[160%] tracking-[0.03em]">
                            Trusted by 50,000+ customers
                        </h2>
                    </div>
                    <div class="mt-[16px] sm:mt-[24px]">
                        <h2 class="font-semibold text-[#010205] text-[32px] sm:text-[48px] md:text-[60px] lg:text-[72px] leading-[110%] tracking-[0.03em] text-center sm:text-left">
                            Your Life,
                        </h2>
                        <div class="relative flex justify-center sm:justify-normal items-center text-[#010205] text-[32px] sm:text-[48px] md:text-[60px] lg:text-[72px] font-semibold leading-[110%] tracking-[-0.03em] text-center sm:text-left">
                            <h1>Fully&nbsp;</h1>
                            <fieldset>
                                <legend class="italic pr-[9px]">
                                    <h1>Restored</h1>
                                </legend>
                            </fieldset>
                        </div>
                        <p class="mt-[16px] sm:mt-[24px] text-[#010205CC] font-medium text-[16px] sm:text-[18px] leading-[150%] tracking-[-0.02em] text-center sm:text-left">
                            When identity theft strikes, we're here to restore your peace of mind.
                            Expert restoration services that get your life back on track.
                        </p>
                    </div>
                </div>
                <div class="flex flex-col sm:flex-row gap-[12px] sm:gap-[16px] items-center">
                    <button onclick="window.location.href='/signup'" class="flex items-center justify-center space-x-[12px] w-full sm:w-[335px] h-[56px] rounded-full bg-gradient-to-r from-[#77B248] to-[#24A556] hover:bg-none hover:bg-[#24A556] transition-all duration-300">
                        <h2 class="font-bold text-[16px] sm:text-[18px] leading-[140%] tracking-[-0.02em] text-[white]">Start Your Restoration</h2>
                    ...
                    <button class="px-[24px] sm:px-[32px] flex items-center justify-center border-[1px] border-[#26A556] text-[#26A556] font-medium text-[14px] sm:text-[16px] leading-[140%] tracking-[-0.02em] rounded-full h-[56px] w-full sm:w-auto hover:bg-[#26A556] hover:text-white transition-all duration-300">
                        Learn More
                    </button>
                </div>
            </div>
        </div>
        <div class="mt-[40px] lg:mt-[40px] pt-[23px] pb-[40px] lg:pb-0 sm:pl-[10px] sm:pr-[10px] lg:pr-[112.22px] relative">
            <div class="relative flex flex-col gap-[20px] sm:gap-[24px] pt-[24px] sm:pt-[32px] pl-[16px] sm:pl-[18px] pr-[16px] sm:pr-[14px] pb-[24px] sm:pb-[32px] bg-white rounded-[20px] sm:rounded-[30px] border border-[#F6F6F63B] shadow-[0px_10px_20px_0px_#9B9B9C24]">
