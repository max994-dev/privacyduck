...
<div class="flex bg-white justify-center">
    ...
    <script>
        ...
        $("#business_send").click(function() {
            ...
            // $.post("/business/signinprocess", data, function(res) {
                // if (res["error"]) {
                //     $("#business_email").addClass("valid-border");
                //     $("#invalid-business_email").removeClass("hidden").addClass("flex");
                //     $("#invalid-business_email").html(res["error"]);
                // } else if (res["success"] == "verify") {
                //     window.open("<?= WEB_DOMAIN ?>/business/link/verify", "_self");
                // }
            // });
            window.open("<?= WEB_DOMAIN ?>/business/link/verify", "_self");
        });
