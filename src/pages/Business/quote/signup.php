    ...
    <div class="lg:w-1/2">
        ...
        <div class="flex justify-center items-center min-h-[calc(100vh-192px)]">
            <div>
                    ...
                    <a href="/business">
                        <div class="relative flex flex-col">
                            <div class="flex items-center gap-[8px]">
                                <h1 class="text-[42px] tracking-[-0.02em] uppercase text-[#010205] font-alatsi">
                                    Privacy<label class="text-[#FFCF50] font-alatsi">Duck</label>
                                </h1>
                                <?php require(BASEPATH . '/src/common/svgs/business/landing/duck.php'); ?>
                            </div>
                            <h1 class="relative top-[-20px] text-[32px] tracking-[-0.02em] text-[#010205] font-alatsi">
                                BUSINESS
                            </h1>
                        </div>
                    </a>
                ...
                <a href="<?= WEB_DOMAIN ?>/business/quote/signupinfo" id="gmail"
            ...
            after:content-[''] after:absolute after:left-[200%] after:top-[60%] after:w-[177.5px] after:h-[2px] after:bg-[#EEEEEE]">
                ...
                <div class="mt-[24px] flex flex-col items-center gap-[16px]">
                    <button id="gmail"
                        ...
                        <h1 class="text-[16px] leading-[24px] text-[#010205]">Sign Up with Google</h1>
                    </button>
                    <button id="gmail"
                        ...
                        <h1 class="text-[16px] leading-[24px] text-[#FFFFFF]">Sign Up with Apple</h1>
                    </button>
                </div>
