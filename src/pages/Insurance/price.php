...
{ ?>
    <div
        class="mt-[20px] sm:mt-0 
                ...
                bg-[#FFFFFF80] 
                items-center 
                lg:min-w-[1000px] shadow-[0px_10px_20px_#9B9B9C24]">
...
?>
<div
    class="px-[20px] justify-center flex">
    <div>
        <div class="sm:mt-[60px] text-[#010205]">
            <div class="mb-[50px] flex flex-col items-center">
                <h2 class="text-[48px] leading-[130%] tracking-[-0.03em] text-[#010205] font-semibold text-center">
                Save More With Our Best Value <br /> and Most Popular Eformion<span class="text-[#00A6C4] font-bold">Go</span> & Privacy<span class="text-[#24A556] font-bold">Duck</span> Plans
                </h2>
                <h2 class="mt-[32px] font-medium text-[18px] text-center leading-[140%] text-[#878C91]">
                Choose the perfect protection plan for you and your family
                </h2>
            </div>
            <?php switches() ?>
            <?php boards() ?>
